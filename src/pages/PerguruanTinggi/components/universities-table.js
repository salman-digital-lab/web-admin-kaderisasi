...
const UniversitiesTable = () => {
    ...
    const { universitiesState, setUniversitiesState, rows, setRows, functions } = useContext(UniversitasContext)
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        <TableRow hover tabIndex={-1} key={index} >
                                            <TableCell component="th" scope="row" className="table-cell"> {(row.id) + (rowsPerPage * page)} </TableCell>
                                            <TableCell className="table-cell">{row.universitas}</TableCell>
