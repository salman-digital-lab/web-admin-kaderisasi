...
<<<<<<< HEAD:src/pages/ActivityDetail/components/Questionnaire/Form/QuestionnaireForm.js

export const QuestionnaireForm = () => {
=======
export const QuestionnaireFormChild = () => {
>>>>>>> fdbc4ecb26963d9e14bf3bcd632cd50cadd6f0e8:src/pages/ActivityDetail/components/Questionnaire/Form/QuestionnaireFormChild.js
  const { id } = useParams()
