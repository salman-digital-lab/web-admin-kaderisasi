...
import { Card, CardContent, InputLabel,
    TextField, Box, FormControl, Select,
    FormLabel, RadioGroup, MenuItem,
    Input, FormControlLabel} from '@material-ui/core';
    ...
    return (
        <Card>
            <CardContent className="filter-content">
                <Box pl={5} pr={5}>
                <TextField id="filled-basic" size="small" label="Cari Aktivis" variant="outlined" className="filter-input" onKeyDown={handleKeyDown} />
                <FormControl component="fieldset" className="radio-button activity">
                    ...
                    <RadioGroup defaultValue="all" aria-label="activity" name="customized-radios">
                        ...
                        <FormControlLabel value="ssc" control={<StyledRadio />} onChange={(e) => filterByStatus(e.target.value)} label="SSC" />
                        <FormControlLabel value="lmd" control={<StyledRadio />} onChange={(e) => filterByStatus(e.target.value)} label="LMD" />
                        <FormControlLabel value="spc" control={<StyledRadio />} onChange={(e) => filterByStatus(e.target.value)} label="SPC" />
                    </RadioGroup>
                </FormControl>
                <FormControl component="fieldset" className="radio-button jenkel">
                    ...
                    <RadioGroup defaultValue="all" aria-label="activity" name="customized-radios">
                        <FormControlLabel value="all" control={<StyledRadio />} onChange={(e) => filterByStatus(e.target.value)} label="Semua" />
                        <FormControlLabel value="male" control={<StyledRadio />} onChange={(e) => filterByStatus(e.target.value)} label="Pria" />
                        <FormControlLabel value="female" control={<StyledRadio />} onChange={(e) => filterByStatus(e.target.value)} label="Perempuan" />
                    </RadioGroup>
                </FormControl>
